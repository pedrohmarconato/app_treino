...
function atualizarCardPrincipal(resultado) {
    ...
    switch (resultado.tipo) {
        ...
        case 'forca': {
            ...
            updateElement(elementos.workoutExercises, `${numExercicios} exercícios • Semana ${semanaProtocolo} • ${tipoTreino}`);
...
function atualizarIndicadoresSemana(resultado) {
    ...
    console.log('[workoutController.atualizarIndicadoresSemana] ✅ Indicadores atualizados para semana', semana);
}
...
export async function testarControllerCompleto(userId) {
    ...
    console.log('🧪 [TESTE-CONTROLLER] CurrentWorkout no AppState:', window.AppState?.get('currentWorkout'));

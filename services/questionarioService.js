...
export class QuestionarioService {
  ...
  static calcularResumoTreino() {
    ...
    const pesoTotalLevantado = execucoesCache.reduce(
      (total, ex) => total + ex.peso * ex.repeticoes,
      0
    );
    const tempoTreino = workoutStartTime
      ? this.formatarTempo((Date.now() - workoutStartTime) / 1000)
      : '00:00';

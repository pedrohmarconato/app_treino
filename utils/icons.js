...
export function getWorkoutIcon(type, size = 'medium', animated = false) {
  ...
  return icon.replace('class="app-icon"', `class="app-icon ${sizeClass} ${animClass}"`).trim();
}
...
export function getActionIcon(action, state = 'default') {
  ...
  const stateClass =
    state === 'active' ? 'icon-active' : state === 'disabled' ? 'icon-disabled' : '';

  return icon.replace('class="app-icon"', `class="app-icon ${stateClass}"`).trim();
}
...
export function getAchievementIcon(type, animated = true) {
  ...
  return icon.replace('class="app-icon"', `class="app-icon ${animClass}"`).trim();
}
...
export function getNavigationIcon(nav, isActive = false) {
  ...
  return icon.replace('class="app-icon"', `class="app-icon ${activeClass}"`).trim();
}

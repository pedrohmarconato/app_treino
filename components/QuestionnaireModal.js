                ...
                <div id="lesoes-section" class="lesoes-section" style="display: ${this.formData.possui_lesao ? 'block' : 'none'};">
                    <div class="form-group">
                        ...
                        <div class="checkbox-grid">
                            ${[
                                'joelho', 'ombro', 'costas', 'tornozelo', 
                                'punho', 'quadril', 'tendinite'
                            ].map(lesao => `
                ...
                <div class="form-group">
                    ...
                    <div class="radio-grid">
                        ${[
                            ...
                            {value: 'emagrecimento', label: '🔥 Emagrecimento', desc: 'Perder peso e gordura'},
                            {value: 'forca', label: '🏋️ Força', desc: 'Aumentar força máxima'},
                            {value: 'resistencia', label: '🏃 Resistência', desc: 'Melhorar condicionamento'},
                            {value: 'condicionamento', label: '⚡ Condicionamento Geral', desc: 'Saúde e bem-estar'}
                        ].map(obj => `

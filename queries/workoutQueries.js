...
export async function buscarTreinoCompleto(userId) {
    console.log('[workoutQueries.buscarTreinoCompleto] 🔍 Buscando dados completos para usuário:', userId);
    ...
    try {
        ...
        console.log('[workoutQueries.buscarTreinoCompleto] 🎯 Planejamento encontrado:', planejamentoHoje);
        ...
        console.log('[workoutQueries.buscarTreinoCompleto] 💪 Exercícios carregados:', resultadoExercicios.data.length);
    ...
    try {
        ...
        return {
            ...
            data: {
                ...
                treinosConcluidos,
                treinosPlanejados,
                percentualConclusao: treinosPlanejados > 0 ? Math.round((treinosConcluidos / treinosPlanejados) * 100) : 0,
